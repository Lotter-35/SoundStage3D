...
export class LaserRenderer {
    constructor(scene) {
        ...
        this.beamsMesh = new THREE.Mesh(this.beamGeo, laserShaderMaterial);
        ...
        this.impactMesh = new THREE.Mesh(this.impactGeo, impactShaderMaterial);
        ...
        this.panImpactMesh = new THREE.Mesh(this.panImpactGeo, panImpactShaderMaterial);
